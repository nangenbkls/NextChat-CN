export const OWNER = "nangenbkls";
export const REPO = "灵犀AI-CN";
export const REPO_URL = `https://github.com/${OWNER}/${REPO}`;
export const PLUGINS_REPO_URL = `https://github.com/${OWNER}/灵犀AI-Awesome-Plugins`;
...
export const STORAGE_KEY = "lingxi-ai-chat";
