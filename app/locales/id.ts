...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Penawaran Peluncuran 灵犀AI AI, buka OpenAI o1, GPT-4o, Claude-3.5 dan model besar terbaru sekarang",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Gunakan 灵犀AI AI",
        Label: "(Solusi paling hemat biaya)",
        SubTitle:
          "Dikelola secara resmi oleh 灵犀AI, siap digunakan tanpa konfigurasi, mendukung model besar terbaru seperti OpenAI o1, GPT-4o, dan Claude-3.5",
